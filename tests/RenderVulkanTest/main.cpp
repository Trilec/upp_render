...
static bool TestSwapchain()
{
	...
	if(!Check(result.invalid_size_refused && result.already_created_refused && result.missing_procedure_recovered, "swapchain refusal and procedure recovery should be explicit")) return false;
