...
static bool TestSharedInstanceRegistry()
{
	...
	if(!Check(first.stable_address_preserved, "stable registry entry address should survive incompatible insertion")) return false;
