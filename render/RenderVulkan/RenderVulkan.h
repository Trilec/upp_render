...
struct VulkanSurfaceReport : Moveable<VulkanSurfaceReport> {
	...
	bool swapchain_requested = false;
	bool swapchain_created = false;
	bool swapchain_state_cleared = true;
	bool swapchain_cleanup_ok = true;
	int swapchain_image_count = 0;
	Size swapchain_extent = Size(0, 0);
	...
	bool swapchain_concurrent_sharing = false;
	uint64_t swapchain_id = 0;
	String swapchain_error;
	int validation_warning_count = 0;
	int validation_error_count = 0;
	Vector<String> validation_messages;
	String runtime_error;
